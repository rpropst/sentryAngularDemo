 ...
 */
function routingInstrumentation(startTransaction, startTransactionOnPageLoad, startTransactionOnLocationChange) {
        ...
        this.navStart$ = this._router.events.pipe(operators_1.filter(function (event) { return event instanceof router_1.NavigationStart; }), operators_1.tap(function (event) {
            ...
            if (activeTransaction) {
                _this._routingSpan = activeTransaction.startChild({
                    ...
                    op: "angular.routing",
                    tags: tslib_1.__assign({ 'routing.instrumentation': '@sentry/angular', url: navigationEvent.url }, (navigationEvent.navigationTrigger && {
